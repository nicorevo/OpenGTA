...
- **Do not invoke from another persona.** If `code-reviewer` flags something that warrants a deeper security pass, the user or the main agent initiates that pass — not the reviewer. See [agent routing](AGENTS.md).
