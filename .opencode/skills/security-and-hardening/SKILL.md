...
These are prevention patterns, not a ranking. For the 2021 ordering, see the quick-reference table in `.opencode/references/security-checklist.md`.
...
For detailed security checklists and pre-commit verification steps, see `.opencode/references/security-checklist.md`.
