...
- For detailed security review guidance, see `.opencode/references/security-checklist.md`
- For performance review checks, see `.opencode/references/performance-checklist.md`
